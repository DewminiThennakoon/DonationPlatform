...
include "connection.php";
  if (isset($_POST['submit'])) {
    ...
    //insert data
    $sql = "INSERT INTO inquiry(`name`, `email`, `mobileNo`, `message`) 
    VALUES ('$name','$email','$mobileNo','$message')";
    ...
    if ($result == TRUE) {
      ...
      //display error alert
      echo '<script>
      window.alert("Error!Failed to send the message");
       window.location.href = "contactUs.php"
      </script>';
    }
    $conn->close();
...
<head>
    ...
    <title>GiveEase | Conatact Us </title>
